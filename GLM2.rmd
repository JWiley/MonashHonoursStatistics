...
## make the incrased self esteem dataset (selfesteem + h)
...
## make the original dataset
originaldata2 <- db[, .(selfesteem, neuroticism)]

## make the incrased self esteem dataset (selfesteem + h)
increasedSelfEsteem <- db[, .(selfesteem = selfesteem + h, neuroticism)]

## make the incrased neuroticism dataset (neuroticism + h)
increasedNeuro <- db[, .(selfesteem, neuroticism = neuroticism + h)]
...
## calculate the average marginal effect s
...
in a `r mean(se.diffprob)` decline in the probability of being high
...
those who may use or be interseted.
...
relative risk of 0.167 of being high stress as do people with low self
esteem. In a simple case like this model, that directly means that
people with high self esteem have 0.167 times the probability of being
